...
//
{
    ...
    if ( ia == 0.0 )
    {
        ...
        dF = kr * Fumax * tstep + Evap.rate*tstep;
        infil->F -= dF;
        infil->Fu -= dF;
//here we try to print change of upper zone moistuter
//here we can see how upper moisture change
           //printf(" %f, %f, %f , %f, %f, %f ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T);
            //printf("\n");
        if ( infil->Fu <= 0.0 )
        {
            infil->Fu = 0.0;
  ...
  //printf("%f, %f, %f , %f, %f, %f, %f, %f ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T,infil->IMDmax,Evap.recoveryFactor);
            //printf("\n");
    ...
    {
        //dF = ia * tstep;
        //here we adjust user provided ET; so less infiltration
        dF = ia * tstep;
        infil->F += dF;
        infil->Fu += dF;
        ...
        if ( modelType == GREEN_AMPT &&  infil->T <= 0.0 )
        {
         ...
         //printf(" %f, %f, %f , %f, %f, %f, %f, %f, %d ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T,infil->IMDmax,Evap.recoveryFactor,1);
           // printf("\n");
...
//here we try to print change of upper zone moistuter
//here we can see how upper moisture change
         //printf(" %f, %f, %f , %f, %f, %f, %f, %f, %d ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T,infil->IMDmax,Evap.recoveryFactor,2);
           // printf("\n");
            //printf(" %f, %f, %f , %f ",infil->Fu,infil->F,ia,Evap.rate);
            //printf(" %f, %f, %f , %f ",infil->Fu,infil->F,Evap.rate*tstep,ia*tstep);
            //printf("\n");
...
//here we try to print change of upper zone moistuter
//here we can see how upper moisture change
  //printf(" %f, %f, %f , %f, %f, %f, %f, %f, %d ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T,infil->IMDmax,Evap.recoveryFactor,3);
    //        printf("\n");
            //printf(" %f, %f, %f , %f ",infil->Fu,infil->F,dF/tstep,Evap.rate);
            //printf(" %f, %f, %f , %f ",infil->Fu,infil->F,Evap.rate*tstep,ia*tstep);
            //printf("\n");
    return dF / tstep;
}
...
//here we try to print change of upper zone moistuter
//here we can see how upper moisture change
 //printf(" %f, %f, %f , %f, %f, %f, %f, %f, %d ",infil->Fu,infil->F,dF, Evap.rate*tstep,ia*tstep,infil->T,infil->IMDmax,Evap.recoveryFactor,4);
   //         printf("\n");
            //printf(" %f, %f, %f , %f, %f ",infil->Fu,infil->F,dF/tstep,Evap.rate,ia);
            //printf(" %f, %f, %f , %f ",infil->Fu,infil->F,Evap.rate*tstep,ia*tstep);
            //printf("\n");
