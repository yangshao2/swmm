...
EXTERN double    ETMatric[ET_ROW][BASINSNUM];                 // Array of et rate (user define)
EXTERN double    ETMatricn[ET_ROW][BASINSNUM];               // Array of et rate - normalized by user defined methods